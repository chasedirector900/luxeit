  ...
  return (
    <main className="min-h-screen animate-pulse bg-slate-50 px-4 pb-28 pt-4 dark:bg-black md:px-8">
      <div className="mx-auto w-full max-w-md md:max-w-5xl">
        ...
        <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white dark:border-zinc-800 dark:bg-zinc-900/70">
          <div className="aspect-[4/5] w-full bg-slate-200 dark:bg-zinc-800" />

          <div className="border-t border-slate-200 bg-slate-50/80 p-2 dark:border-zinc-800 dark:bg-zinc-900/70">
          ...
          <div className="space-y-3 p-3">
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50/80 p-2.5 dark:border-zinc-800 dark:bg-zinc-900/70">
        ...
        <section className="mt-3 rounded-2xl border border-slate-200 bg-white/90 p-3 dark:border-zinc-800 dark:bg-zinc-900/60">
      ...
      <div className="fixed inset-x-0 bottom-[calc(4.4rem+env(safe-area-inset-bottom))] z-40 px-4 md:hidden">
        <div className="mx-auto w-full max-w-md rounded-2xl border border-slate-200 bg-white/95 p-2 dark:border-zinc-800 dark:bg-zinc-950/95">
