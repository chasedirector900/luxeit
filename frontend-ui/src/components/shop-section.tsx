      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="flex items-center justify-between border-b border-gold-200/70/60 pb-3 dark:border-gold-900/40/80">
          <div className="inline-flex items-center gap-2 text-slate-900 dark:text-zinc-100">
            <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-gold-500/10 text-gold-600 dark:text-gold-400">
        ...
        <article className="mt-3 overflow-hidden rounded-2xl border border-gold-200/70 bg-white p-2.5 shadow-sm dark:border-gold-900/40/60 dark:bg-gradient-to-br dark:from-zinc-900/90 dark:via-zinc-950 dark:to-black/95 sm:mt-4 sm:rounded-3xl sm:p-5">
          <div className="block lg:hidden">
            <div className="relative h-[132px] overflow-hidden rounded-xl border border-gold-100/70 dark:border-gold-900/40/60 min-[390px]:h-[150px] sm:h-auto sm:rounded-2xl">
              <Image
              ...
              />
              <div className="pointer-events-none absolute right-2 top-2 h-6 w-6 rounded-full bg-gold-500/15" />
            </div>

            <div className="mt-1.5 flex items-center justify-between">
              <div className="inline-flex items-center gap-1 rounded-full border border-gold-200/70 bg-white/80 px-1.5 py-0.5 text-[9px] font-bold dark:border-gold-900/40 dark:bg-zinc-900/70">
                <PackageCheck className="h-2.5 w-2.5 text-gold-500" />
            ...
            <div className="mt-2">
              <span className="inline-flex items-center rounded-md border border-gold-500/30 bg-gold-500/10 px-1.5 py-0.5 text-[8px] font-black tracking-wider text-gold-600 uppercase dark:text-gold-400">
                Physical Products
              </span>

              <h3 className="mt-1.5 text-[22px] font-black leading-none tracking-tight text-slate-900 dark:text-white min-[390px]:text-2xl">
                Shop <span className="text-gold-600 dark:text-gold-400">Premium Products</span>
              </h3>
              ...
              <div className="mt-2 flex flex-wrap items-center gap-1 text-[8px] font-bold text-slate-500 dark:text-zinc-400 min-[390px]:text-[9px]">
                <span className="inline-flex items-center gap-1 rounded-full border border-gold-200/70 px-1.5 py-0.5 dark:border-gold-900/40">
                  <Globe2 className="h-2.5 w-2.5 text-gold-500" /> Shipping
                </span>
                <span className="inline-flex items-center gap-1 rounded-full border border-gold-200/70 px-1.5 py-0.5 dark:border-gold-900/40">
                  <BadgeCheck className="h-2.5 w-2.5 text-gold-500" /> Secure
                </span>
                <span className="inline-flex items-center gap-1 rounded-full border border-gold-200/70 px-1.5 py-0.5 dark:border-gold-900/40">
                  <CreditCard className="h-2.5 w-2.5 text-gold-500" /> Card
                </span>
              </div>

              <div className="mt-2 flex items-center justify-between rounded-lg border border-gold-100/70 bg-slate-50/60 px-2 py-1.5 dark:border-zinc-900 dark:bg-zinc-900/40">
                ...
                <span className="rounded border border-gold-200/70 bg-slate-100 px-1.5 py-0.5 text-[8px] font-bold dark:border-gold-900/40 dark:bg-zinc-950 dark:text-zinc-400">
                  CN
                </span>
              </div>
          ...
          <div className="hidden items-center gap-8 lg:grid lg:grid-cols-12">
            <div className="space-y-5 lg:col-span-7">
              <span className="inline-flex items-center rounded-md border border-gold-500/30 bg-gold-500/10 px-2.5 py-0.5 text-[9px] font-black uppercase tracking-widest text-gold-600 dark:text-gold-400">
                Physical Products
              </span>
              ...
              <div className="flex items-center justify-between rounded-xl border border-gold-100/70 bg-slate-50/50 px-4 py-3 backdrop-blur-md dark:border-zinc-900 dark:bg-zinc-900/40">
                ...
                <span className="rounded border border-gold-200/70 bg-slate-100 px-1.5 py-0.5 text-[9px] font-extrabold text-slate-700 dark:border-gold-900/40 dark:bg-zinc-950 dark:text-zinc-400">
                  CN
                </span>
              </div>
            ...
            <div className="relative flex flex-col items-center justify-center lg:col-span-5">
              <div className="pointer-events-none absolute right-4 top-4 h-24 w-24 rounded-full bg-gold-500/5 blur-xl" />
              <div className="pointer-events-none absolute bottom-4 left-4 h-32 w-32 rounded-full bg-gold-500/10 blur-2xl" />
              ...
              <div className="mt-4 flex items-center gap-2 rounded-full border border-gold-200/70/80 bg-white/70 px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-wide shadow-sm backdrop-blur-md dark:border-gold-900/40 dark:bg-zinc-900/60">
                <PackageCheck className="h-3.5 w-3.5 text-gold-500" />
                <span className="text-slate-700 dark:text-zinc-300">{shopSlides[activeSlide].tag.split(" · ")[0]}</span>
                <span className="text-gold-500">· {shopSlides[activeSlide].tag.split(" · ")[1]}</span>
              </div>
            </div>
          </div>

          <div className="mt-3 border-t border-gold-100/70 pt-3 transform-gpu will-change-transform dark:border-zinc-900/80 sm:mt-6 sm:pt-5">
                ...
                <button
                  ...
                  className={`group flex h-[66px] flex-col items-center justify-center rounded-lg border p-2 shadow-sm transition-all duration-200 transform-gpu active:scale-[0.98] outline-none sm:h-24 sm:rounded-xl sm:p-3 lg:h-28 ${
                    activeCategoryKey === item.key
                      ? "border-gold-500/60 bg-gold-500/10 dark:border-gold-400/50 dark:bg-gold-500/10"
                      : "border-gold-200/70/60 bg-slate-50/50 hover:border-gold-500/30 hover:bg-white dark:border-gold-900/40/60 dark:bg-zinc-900/30 dark:hover:border-gold-400/30 dark:hover:bg-zinc-900/60"
                  }`}
                  type="button"
                >
                  <div className={`flex h-7 w-7 items-center justify-center rounded-md border shadow-inner transition-colors duration-200 sm:h-9 sm:w-9 sm:rounded-lg ${
                    activeCategoryKey === item.key
                      ? "border-gold-500/30 bg-gold-500/10 dark:border-gold-400/30 dark:bg-gold-500/10"
                      : "border-gold-200/70/40 bg-slate-100 group-hover:border-gold-500/20 dark:border-gold-900/40/40 dark:bg-zinc-950"
                  }`}>
                    <item.Icon className={`h-3.5 w-3.5 transition-colors duration-200 sm:h-4 sm:w-4 ${
                      activeCategoryKey === item.key
                        ? "text-gold-600 dark:text-gold-400"
                        : "text-slate-500 group-hover:text-gold-600 dark:text-zinc-400 dark:group-hover:text-gold-400"
                    }`} />
                  </div>
