      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="mt-5 flex w-full gap-4 overflow-x-auto pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          {Array.from({ length: 3 }).map((_, idx) => (
            <article
              key={idx}
              className="w-[78vw] sm:w-[260px] md:w-[240px] shrink-0 overflow-hidden rounded-2xl border border-gold-200/70 bg-white p-2 dark:border-gold-900/40/60 dark:bg-zinc-950/60"
            >
              ...
              <div className="mt-2.5 space-y-1.5 rounded-xl border border-gold-100/70/50 bg-slate-100/60 p-2 dark:border-zinc-900/40 dark:bg-zinc-900/40">
                ...
                <div className="border-t border-gold-100/70 pt-1.5 dark:border-zinc-900/60">
