    ...
    >
      <div className="mb-3 flex items-center justify-between gap-3 px-1">
        <div className="flex min-w-0 items-center gap-2.5">
          <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-amber-500/80 text-neutral-950">
        ...
        <div className="h-6 w-16 rounded-full bg-amber-500/20 dark:bg-amber-500/10" />
      </div>
        ...
        {Array.from({ length: cards }).map((_, idx) => (
          ...
          >
            <div className="relative h-[390px] w-full overflow-hidden rounded-[22px] bg-zinc-900">
              ...
              <div className="absolute left-2.5 top-2.5 h-6 w-24 rounded-full bg-amber-500/20" />
              ...
              <div className="absolute inset-x-0 bottom-0 p-3">
                <div className="mb-2 h-3 w-20 rounded bg-amber-500/40" />
