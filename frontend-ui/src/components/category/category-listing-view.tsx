      ...
      <div className="mx-auto w-full max-w-md space-y-5 md:max-w-6xl">
        ...
        <header className="reveal-up space-y-3">
          <div className="flex items-center justify-between gap-3">
            <Link
              ...
              className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-gold-200/70 bg-white text-slate-700 shadow-sm shadow-slate-900/[0.04] transition-transform duration-100 active:scale-95 dark:border-gold-900/40 dark:bg-zinc-900 dark:text-zinc-300 dark:shadow-none"
            >
        ...
        {isBrowsing ? (
          <section
            ...
            className="reveal-up grid grid-cols-3 gap-2 rounded-2xl border border-gold-200/70 bg-white p-3 dark:border-gold-900/40 dark:bg-zinc-900"
          >
