  ...
  return (
    <>
      <section className="px-4 pb-24 md:hidden animate-pulse">
        <div className="mx-auto w-full max-w-md rounded-2xl border border-slate-200/80 bg-white/95 p-4 dark:border-white/10 dark:bg-surface">
      ...
      <section className="hidden px-4 pb-8 md:block animate-pulse">
        <div className="mx-auto w-full max-w-7xl rounded-2xl border border-slate-200/70 bg-white/95 p-4 dark:border-white/10 dark:bg-surface">
          <div className="flex items-center justify-between gap-4 rounded-2xl border border-slate-200/70 bg-slate-50/70 p-4 dark:border-white/10 dark:bg-zinc-900/40">
