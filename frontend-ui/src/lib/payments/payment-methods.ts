...
export const PAYMENT_BRANDS: PaymentBrandMeta[] = [
  { brand: "visa", label: "Visa", desc: "Credit / debit card", kind: "card", icon: CreditCard, tint: "text-gold-600 dark:text-gold-400", ring: "bg-gold-500/10", gradient: "from-gold-600 to-gold-700" },
  { brand: "mastercard", label: "Mastercard", desc: "Credit / debit card", kind: "card", icon: CreditCard, tint: "text-gold-600 dark:text-gold-400", ring: "bg-gold-500/10", gradient: "from-gold-500 to-red-600" },
  ...
  { brand: "mtn", label: "MTN MoMo", desc: "Mobile money", kind: "mobile", icon: Smartphone, tint: "text-gold-600 dark:text-gold-400", ring: "bg-gold-500/10", gradient: "from-gold-400 to-gold-500" },
];
